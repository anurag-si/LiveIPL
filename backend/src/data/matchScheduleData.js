...
const getLiveMatch = () => {
  return matchSchedule.find(match => match.status === "live");
};

const getUpcomingMatches = () => {
  return matchSchedule.filter(match => match.status === "upcoming");
};

const getCompletedMatches = () => {
  return matchSchedule.filter(match => match.status === "completed");
};
